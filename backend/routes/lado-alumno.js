...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    ...
    const alumnoFolderPath = path.resolve(
      __dirname,
      "..",
      "documents",
      alumnoFolderName
      ...
      const infoCPA = {
        ...
        datosAcademicos: {
          datosAcademicosAlumno: {
            nivelAcademico:
              estadia.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
                .nivelAcademico,
            turno:
              estadia.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
                .turno,
            carrera:
              estadia.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
                .carrera,
            area: estadia.cartaPresentacion.datosAcademicos
              .datosAcademicosAlumno.area,
            grado:
              estadia.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
                .grupo,
            grupo:
  ...
  try {
    ...
    const cpa = {
      ...
      datosAcademicos: {
        datosAcademicosAlumno: {
          nivelAcademico:
            req.body.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
              .nivelAcademico,
          turno:
            req.body.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
              .turno,
          carrera:
            req.body.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
              .carrera,
          area: req.body.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
            .area,
          grado:
            req.body.cartaPresentacion.datosAcademicos.datosAcademicosAlumno
              .grado,
      ...
      datosEmpresa: {
        ...
        nombreEmpresario:
          req.body.cartaPresentacion.datosEmpresa.nombreEmpresario,
        puestoEmpresario:
          req.body.cartaPresentacion.datosEmpresa.puestoEmpresario,
      },
...
router.patch("/cpa/modificar", async (req, res) => {
  try {
    ...
    estadia.cartaPresentacion.estado.nombre =
      cpa.estado.nombre || estadia.cartaPresentacion.estado.nombre;
    estadia.cartaPresentacion.estado.motivo =
      cpa.estado.motivo || estadia.cartaPresentacion.estado.motivo;
    estadia.cartaPresentacion.estado.fecha =
      cpa.estado.fecha || estadia.cartaPresentacion.estado.fecha;
    ...
    estadia.cartaPresentacion.datosAlumno.nombres.apPaterno =
      nombres.apPaterno || "";
    estadia.cartaPresentacion.datosAlumno.nombres.apMaterno =
      nombres.apMaterno || "";

    const privado = datosAlumno.privado;
    estadia.cartaPresentacion.datosAlumno.privado.matricula =
      privado.matricula ||
      estadia.cartaPresentacion.datosAlumno.privado.matricula;
    estadia.cartaPresentacion.datosAlumno.privado.email =
      privado.email || estadia.cartaPresentacion.datosAlumno.privado.email;
    estadia.cartaPresentacion.datosAlumno.telefonoCelular =
    ...
    estadia.cartaPresentacion.datosAlumno.telefonoCasa =
      ...
      estadia.cartaPresentacion.datosAlumno.telefonoCasa;
    estadia.cartaPresentacion.datosAlumno.nss =
      datosAlumno.nss || estadia.cartaPresentacion.datosAlumno.nss;
    estadia.cartaPresentacion.datosAlumno.curp =
      datosAlumno.curp || estadia.cartaPresentacion.datosAlumno.curp;
    ...
    estadia.cartaPresentacion.datosAcademicos.datosAcademicosAlumno.grupo =
      ...
      estadia.cartaPresentacion.datosAcademicos.datosAcademicosAlumno.grupo;
    estadia.cartaPresentacion.datosAcademicos.periodo =
      datosAcademicos.periodo ||
      estadia.cartaPresentacion.datosAcademicos.periodo;
    estadia.cartaPresentacion.datosAcademicos.año =
      datosAcademicos.año || estadia.cartaPresentacion.datosAcademicos.año;
...
router.post("/documentos/subir", upload.array("archivos"), async (req, res) => {
  try {
    ...
    for (const archivo of req.files) {
      ...
      archivo.filename === "CurriculumVitaeEspanol.pdf"
        ? (objKey = "curriculumEspanol")
        : "";
      archivo.filename === "CurriculumVitaeIngles.pdf"
        ? (objKey = "curriculumIngles")
        : "";
...
router.patch("/academico/anteproyecto/modificar", async (req, res) => {
  try {
    ...
    estadia.anteproyecto.datosAsesorAcademico.nombre =
      datosAsesorAcademico.nombre;
    estadia.anteproyecto.datosAsesorAcademico.email =
      datosAsesorAcademico.email;
    estadia.anteproyecto.datosAsesorAcademico.telefono =
      datosAsesorAcademico.telefono;

    const datosAsesorEmpresarial = anteproyecto.datosAsesorEmpresarial;
    estadia.anteproyecto.datosAsesorEmpresarial.nombre =
      datosAsesorEmpresarial.nombre;
    estadia.anteproyecto.datosAsesorEmpresarial.email =
      datosAsesorEmpresarial.email;
    estadia.anteproyecto.datosAsesorEmpresarial.telefono =
      datosAsesorEmpresarial.telefono;
...
// POST - Ver informacion del solicitud / progreso de Estadias
router.post("/academico/estadias", async (req, res) => {
  try {
...
// POST - Agregar solicitud / progreso de estadias
router.post("/academico/estadias/guardar", async (req, res) => {
  try {
    const { idAlumno, progreso, nombreEmpresa } = req.body;
    const alumno = await Alumno.findById(idAlumno);
    const alumnoInfo = {
      nombres: alumno.datosPersonales.nombres,
      matricula: alumno.datosPersonales.privado.matricula,
      email: alumno.datosPersonales.privado.email,
      datosAcademicos: alumno.datosAcademicos,
    };
    const solicitud = {
      idAlumno,
      alumno: alumnoInfo,
    ...
    const searchSolicitud = await SolicitudEstadia.findOne({ idAlumno });
    if (searchSolicitud) {
        const newObj = Object.assign(searchSolicitud, solicitud);
        const newSolicitud = await SolicitudEstadia.findByIdAndUpdate(searchSolicitud._id, newObj);
        return res.status(201).json(newSolicitud);
    }
    const newSolicitud = new SolicitudEstadia(solicitud)
    const solicitudSaved = await newSolicitud.save();
    if (Object.keys(solicitudSaved).length == 0) {
      return res.status(500).json({
        message: "Ha ocurrido un error insertando la solicitud de estadia",
      });
    }
