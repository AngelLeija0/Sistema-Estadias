...
// POST - Aceptar o rechazar de anteproyecto
router.post('/alumno/perfil/anteproyecto/toggle', async (req, res) => {
    try {
        ...
        estadia.anteproyecto.estado.nombre = estado.nombre;
        estadia.anteproyecto.estado.motivo = estado.motivo;
        estadia.anteproyecto.estado.fecha = estado.fecha;

        estadia.avance.anteproyecto.estado = avance.toString();
        estadia.avance.anteproyecto.fecha = new Date();

        await Estadia.findByIdAndUpdate(estadia._id, estadia);

        res.json(estadia.anteproyecto.estado);
...
router.patch('/alumno/perfil/avance', async (req, res) => {
    try {
