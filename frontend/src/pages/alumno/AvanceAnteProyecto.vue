  ...
  <div v-if="pageLoaded">
    ...
    <div class="container-fluid">
      ...
      <p style="padding-left: 60px; font-size: 20px; padding-right: 60px">
        En esta seccion puedes verificar el avance de tu seguimiento academico.
      </p>
      ...
      <div class="card-container" style="margin-top: 0">
        ...
        >
          <div class="col-lg-2 col-md-4 col-6 q-pt-md">
            ...
            >
              <q-card-section class="text-white">Anteproyecto</q-card-section>
            </q-card>
            <p
              v-if="progress[0].state === 'true'"
              style="margin: 5px 0 0 15px; font-size: 13px; color: #777767"
            >
          ...
          <div class="col-lg-2 col-md-4 col-6 q-pt-md">
            ...
            >
              <q-card-section class="text-white"
                >Revisión ortográfica</q-card-section
              >
            </q-card>
            <p
              v-if="progress[5].state === 'true'"
              style="margin: 5px 0 0 15px; font-size: 13px; color: #777767"
            >
  ...
  setup() {
    ...
    function loadProgress() {
      ...
      try {
        api
          .post(
            `http://localhost:3000/alumno/academico/avance`,
            {
              idAlumno: idStudent,
            }
          )
