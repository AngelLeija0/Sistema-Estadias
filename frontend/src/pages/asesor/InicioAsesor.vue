<template>
  ...
  <div class="container-fluid">
    <div class="row q-pl-xl q-pr-xl" style="background-color: #f5f5f5">
      <h5 style="font-size: 24px; font-weight: 500;">Alumnos asesorados</h5>
    </div>
  </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    toGenerateExcel() {
      ...
      const idAsesor = this.userStore.getUser.id;
      ...
      api
        ...
        .then((res) => {
          if (res.data.msg) {
            ...
            link.href = url;
            link.setAttribute("download", "alumnos-asesorados.xlsx");
